...
### Added
- SGR-Pixels mouse mode (DECSET 1016) — reports mouse coordinates in pixel units for sub-cell precision ([#4](https://github.com/sanohiro/bcon/pull/4), contributed by [@kay-ws](https://github.com/kay-ws))
